...
本章是“先认识两种推理方式”的 **P1 入门页**：区间调度用来练贪心证明，一维题用来练状态定义。二维编辑距离展示完整 DP 与答案恢复，但对普通 HFT/基础设施面试属于 **P2 补充**。如果你已能解释状态、转移、初始化和遍历顺序，无需为了完成目录继续刷完 [DP 模式章](dp_patterns.md)。
...
6. **P2**：如何从最优值恢复一组具体选择？
7. **P2**：空间压缩需要检查哪些依赖和更新顺序？
8. **P2**：为什么完整二维表正确后，再压缩通常更稳？
