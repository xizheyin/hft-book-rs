...
# 第二部分：Rust 语义与抽象成本 (Rust Cost Model)
...
- [可扩展性设计：分片、Share-Nothing 与核间通信](infrastructure/scalability.md)
...
# 第五部分：应用专题：电子市场消息系统 (Applications)
...
# 第六部分：性能工程与验证 (Performance Engineering)
