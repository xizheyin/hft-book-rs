...
- 用一套稳定框架回答开放式 HFT 设计题；
- 主动澄清市场、负载、延迟口径和一致性要求；
- 设计正常路径、恢复路径和控制路径；
- 解释线程模型、订单状态、风控预占和幂等性；
- 做数量级容量估算，并处理面试官的深入追问。
...
时间紧时也不要跳过 1、4、6。很多候选人能画快速通路，却无法说明数据缺口和未知订单状态怎么办。
...
| 时间 | 内容 |
| ---: | --- |
| 0–5 分钟 | 澄清范围、负载、SLO、风险原则 |
| 5–10 分钟 | 写功能/非功能需求与假设 |
| 10–18 分钟 | 画端到端图并走一遍正常生命周期 |
| 18–27 分钟 | 下钻状态、线程模型、风控和顺序 |
| 27–33 分钟 | 故障、恢复、幂等和对账 |
| 33–38 分钟 | 容量与延迟预算 |
| 38–43 分钟 | 测试、监控、发布、合规 |
| 43–45 分钟 | 总结权衡，邀请面试官选择下钻点 |
